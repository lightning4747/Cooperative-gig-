  ...
  const newJob: Job = isEmergency
    ? {
        ...
        location: {
          latitude: 12.936,
          longitude: 77.626,
          formattedAddress: '5th Block, Koramangala, Bengaluru 560095',
          area: 'Koramangala (0.6 km away)',
        },
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
        basePrice: 650,
    ...
    : {
        ...
        location: {
          latitude: 12.931,
          longitude: 77.623,
          formattedAddress: '1st Block, Koramangala, Bengaluru 560034',
          area: 'Koramangala (1.1 km away)',
        },
        ...
        allocationBreakdown: {
          ...
          totalScore: 0.89,
          explanation:
            'Assigned via cooperative fair allocation: Nearest verified plumber (1.1 km) with 4.8 rating and balanced daily workload.',
        },
      }
