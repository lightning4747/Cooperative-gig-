...
function mapBackendJobToJob(b: any): Job {
  ...
  return {
    ...
    societyName: b.societyName || b.society_name || undefined,
    workerRating: b.workerRating || b.worker_rating ? Number(b.workerRating || b.worker_rating) : undefined,
    serviceCategoryId,
    serviceCategoryName,
    subserviceId,
    subserviceName,
    ...
    location: {
      latitude: Number(b.latitude || 11.0183),
      longitude: Number(b.longitude || 76.9644),
      formattedAddress: b.formattedAddress || b.formatted_address || '',
      area: b.area || 'Coimbatore',
    },
  ...
  createJob: async (input: CreateJobInput & { quoteId?: string }): Promise<Job> => {
    ...
    const res = await apiClient.post(
      '/jobs',
      {
        ...
        area: input.location.area || 'Coimbatore',
        scheduledTime,
      },
      {
        headers: {
    ...
    try {
      ...
      return res.data.map((o) =>
        mapBackendJobToJob({
          ...
          workerId,
          status: 'OFFERED',
          area: o.area || 'Coimbatore',
          formattedAddress: o.formattedAddress || o.formatted_address || o.area || 'Gandhipuram, Coimbatore',
          latitude: o.latitude || 11.0183,
          longitude: o.longitude || 76.9644,
