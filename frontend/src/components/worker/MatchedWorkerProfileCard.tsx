...
export function MatchedWorkerProfileCard({
  ...
  societyRegistration: _societyRegistration = 'SOC-BLR-IND-2021-042',
  membershipId: _membershipId = 'MBR-IND-8841',
  rating = 4.8,
  totalJobs = 184,
  otpCompliance: _otpCompliance,
  eShramUan: _eShramUan = 'UAN-9921-8841-3201',
  skillCertification = 'Electrician & Appliance Technician',
